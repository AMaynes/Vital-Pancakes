...
const APP_SHELL = [
  ...
  "./tools/visual-board.js?v=33",
  "./tools/visual-board-ai.css?v=1",
  "./tools/visual-board-advanced.css?v=2",
  "./tools/visual-board-ai-adapter.mjs?v=3",
  "./tools/visual-board-image.mjs?v=1",
  "./tools/visual-board-transform.mjs?v=2",
  "./tools/visual-board-architecture.mjs?v=1",
  "./tools/visual-board-static-export.mjs?v=1",
  "./tools/visual-board-floor-plan.mjs?v=1",
  ...
  "./tools/visual-board-geometry.mjs?v=9",
