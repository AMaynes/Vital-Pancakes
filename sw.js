...
const CACHE_NAME = "vital-pancakes-app-v63";
...
const APP_SHELL = [
  ...
  "./tools/visual-board.js?v=38",
  "./tools/visual-board-ai.css?v=1",
  "./tools/visual-board-advanced.css?v=3",
  "./tools/visual-board-ai-adapter.mjs?v=6",
  ...
  "./tools/visual-board-static-export.mjs?v=3",
  "./tools/visual-board-floor-plan.mjs?v=2",
  "./tools/visual-board-floor-plan-templates.mjs?v=1",
