...
const CACHE_NAME = "vital-pancakes-app-v112";
...
const OFFLINE_ASSET_CATALOG = [
  ...
  "./app/knowledge-entry-model.mjs?v=3",
  "./app/knowledge-entry-model.mjs?v=4",
  ...
  "./tools/literature-analyzer.css?v=9",
  "./tools/literature-analyzer.js?v=9",
