...
│   ├── visual-board-groups.test.mjs — Verifies nested grouping, logical selection units, resizing, and rotation.
...
│   ├── visual-board-fill.mjs — Finds closed vector faces and creates editable paint-bucket areas beneath their boundaries.
│   ├── visual-board-fill.test.mjs — Verifies object fills, connected regions, open boundaries, and nested faces.
